  ...
  var Validator = function (options) {
    ...
    */
    this.messages = {
      ...
      , rangelength: "La longitud de este valor no es válida. Debe tener entre% sy% s caracteres de longitud."
